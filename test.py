...
from services.emergency_report_service import get_emergency_appeals_for_date,get_emergency_category_stats
if __name__ == "__main__":

    s_data = get_emergency_category_stats("2025-10-26")
